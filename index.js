...
//  })
// app.get("/",(req,res)=>{
//     const sqlInsert="insert into contactdetails(name , email,contact) values('josna','jhoo@gmail.com','123456780')";
...
//     const{id}=req.params;
//     const {name,email,contact}=req.body;
//     const sqlInsert="update contactdetails set name=? email=? contact=? where values id=?";
//     db.query(sqlInsert,[name,email,contact],(error,result)=>{
//         console.log("error",error);
//         console.log("result",result);
//         res.send(result);
